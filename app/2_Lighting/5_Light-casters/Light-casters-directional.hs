...
main = do
    ...
    lightingShader <- simpleShaderProgram ("data" </> "2_Lighting" </> "5_Light-casters" </> "directional.vs")
        ("data" </> "2_Lighting" </> "5_Light-casters" </> "directional.frag")
...
drawScene lightingShader contVAO lampShader lightVAO w cam = do
    ...
    setUniform lightingShader "light.direction" (V3 (-0.2 :: GLfloat) (-1.0) (-0.3))
