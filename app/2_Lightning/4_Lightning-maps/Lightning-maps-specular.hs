...
main = do
    ...
    lightningShader <- simpleShaderProgram ("data" </> "2_Lightning" </> "4_Lightning-maps" </> "specular.vs")
        ("data" </> "2_Lightning" </> "4_Lightning-maps" </> "specular.frag")

    diffuseMap <- createTexture ("data" </> "2_Lightning" </> "4_Lightning-maps" </> "container2.png")
    specularMap <- createTexture ("data" </> "2_Lightning" </> "4_Lightning-maps" </> "container2_specular.png")
    ...
    setUniform lightningShader "material.specular" (TextureUnit 1)
